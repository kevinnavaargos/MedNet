"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _updateUserInfoController = require('./../controllers/updateUserInfoController');
...
userRouter.post('/data/update', _validateToken.validateToken, updateUserInfo.handle)
userRouter.post('/data', _validateToken.validateToken, inserData.handle);
userRouter.get('/data/health', _validateToken.validateToken, findUserInfo.handle);
